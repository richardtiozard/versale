        ...
        <div class="warpper">
            <div class="px-5 d-flex justify-content-between">
                <h4 class="d-inline-block font-weight-600">
                    <i class="fas fa-users"></i> Admin Registration
                </h4>
                <a :href="'/admin/users'">
            ...
            <div v-if="page == 1" id="page1" class="mx-auto p-5 mt-5 text-left position-relative custom-box-shadow">
            ...
            <div v-if="page == 2" id="page2" class="mx-auto p-5 mt-5 text-center position-relative custom-box-shadow">
                <div @click="stepBack" class="backbtn position-absolute text-7"><h6> <i class="fas fa-angle-left"></i> Back</h6></div>
                
                <div class="text-left mt-4">

                    <div v-if="isSuccess" class="successmsg p-3 mt-5"><i class="fas fa-check text-9 mr-2"></i> Successfully registered. </div>
                    <div v-if="isError" class="errormsg p-3 mt-5"><i class="fas fa-times text-8 mr-2"></i> {{ errortext }}</div>
                    <div v-if="isEmpty" class="errormsg p-3 mt-5"><i class="fas fa-exclamation text-8 mr-2"></i> Please enter all the required fields. </div>        
    ...
    methods:{
        ...
        checkUser(){
            if (this.user.email == "" || this.user.password == "" || this.user.confirmpassword == ""){
                ...
                axios.post('/admin/users/register', {
                    user: this.user
                })
                .then( response => {
                    console.log('success');
